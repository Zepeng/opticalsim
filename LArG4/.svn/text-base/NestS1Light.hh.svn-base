#ifndef NestS1Light_h
#define NestS1Light_h 1
...
#include "LArG4/LArNestInterface.h"
...
class NestS1Light : public larg4::OpFastScintillation
{
  // Class inherits publicly from G4VRestDiscreteProcess
private:
  larg4::LArNestInterface& flni; // LArNestInterface reference

public: // constructor and destructor

        NestS1Light(const G4String& processName = "S1",
...
////////////////////
inline 
G4bool NestS1Light::IsApplicable(const G4ParticleDefinition& aParticleType)
{
...
inline 
void NestS1Light::SetTrackSecondariesFirst(const G4bool state) 
{ 
	fTrackSecondariesFirst = state;
}

inline
G4bool NestS1Light::GetTrackSecondariesFirst() const
{
        return fTrackSecondariesFirst;
}

inline
void NestS1Light::SetScintillationYieldFactor(const G4double yieldfactor)
{
  YieldFactor = yieldfactor;
}

inline
G4double NestS1Light::GetScintillationYieldFactor() const
{
        return YieldFactor;
}

inline
void NestS1Light::SetScintillationExcitationRatio(const G4double excitationratio)
{
        ExcitationRatio = excitationratio;
}

inline
G4double NestS1Light::GetScintillationExcitationRatio() const
{
